...
def validate_request_data(x):
    ...
    if scheduled.minute not in {0,10,20,30,40,50} or scheduled.second or scheduled.microsecond: raise ValueError("publication.publish_at must be on minute 00, 10, 20, 30, 40, or 50")
