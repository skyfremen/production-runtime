...
from resources.validate import validate_registry_data, validate_request_backgrounds
...
class MediaRegistryTests(unittest.TestCase):
    ...
    def test_registry_allows_4k_landscape_when_vertical_crop_requires_it(self):
        data = registry()
