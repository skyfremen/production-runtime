...
from transform.synth import OnnxKokoroSynthesizer, sentence_chunks, validate_audio
from transform.verify import inline_blackdetect_max
...
class OnnxNarrationTests(unittest.TestCase):
    ...
    def test_renderer_keeps_primary_and_fallback_contract(self):
        source = (ROOT / "runtime/transform/compose.py").read_text(encoding="utf-8")
